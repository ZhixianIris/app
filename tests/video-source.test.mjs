...
describe("shouldSendHlsCredentials", () => {
  test("credentials only for our API playlist endpoint", () => {
    expect(shouldSendHlsCredentials("https://api.example.com/api/v1/stream/hls/o/c/a/master.m3u8")).toBe(true);
    expect(shouldSendHlsCredentials("https://api.example.com/api/v1/stream/hls/o/c/a/v720p/index.m3u8")).toBe(true);
  });
