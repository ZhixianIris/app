 ...
 * isSubdomainOf("acme.example.com:3000", "example.com") -> true
 * isSubdomainOf("example.com", "example.com") -> false (same host, not a subdomain)
 */
 ...
 * Both may include ports — ports are stripped before comparison.
 * extractSubdomain("acme.example.com:3000", "example.com") -> "acme"
 * extractSubdomain("example.com", "example.com") -> null
 * extractSubdomain("localhost", "example.com") -> null
 */
