...
export const ERROR_CATALOG: ErrorCategory[] = [
  {
    ...
    description:
      'A new version of Learning Web was released while this page was open, so it briefly fell out of sync. Reloading will pick up the latest version.',
    matchers: {
      statuses: [],
      messageIncludes: [
  ...
  },
  {
    ...
    matchers: {
      ...
      messageIncludes: [
        ...
        'email service',
        'set learningWeb_judge0_api_url',
      ],
      names: [],
    },
