...
>(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.Content
    ref={ref}
    className={cn(
      "start-0 top-0 w-full data-[motion^=from-]:animate-in data-[motion^=to-]:animate-out data-[motion^=from-]:fade-in data-[motion^=to-]:fade-out md:absolute md:w-auto",
      // Radix's `data-motion` is keyed on LOGICAL start/end, unlike `data-side`
      // elsewhere in these primitives which reports the resolved physical side.
      // So the slide direction has to be mirrored explicitly for RTL.
