                ...
                <div className="animate-pulse px-6 py-4 space-y-0">
                  ...
                  {Array.from({ length: ITEMS_PER_PAGE }).map((_, i) => (
                    <div key={i} className="flex items-center gap-4 py-4 border-b border-gray-50">
                      ...
                      {/* Actions */}
                      <div className="h-8 bg-gray-100 rounded-md w-24 ms-auto" />
                    </div>
                  ))}
                </div>
              ) : orgUsers.length === 0 ? (
                  ...
                  <thead>
                    <tr className="border-b border-gray-100">
                      ...
                      {customFields.map((field) => (
                        <th
                          key={field.key}
                          className="text-start text-xs font-semibold text-gray-500 uppercase tracking-wider px-6 py-3 whitespace-nowrap"
                        >
