...
export default function AuthBrandingPanel({ org, welcomeText, title, subtitle }: AuthBrandingPanelProps) {
  ...
  const noOrgTitle = title || 'Welcome back to Learning Web.'
  const noOrgSubtitle =
    ...
    <div className="relative h-full w-full">
      ...
      <div className="absolute inset-16 rounded-2xl overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col h-full p-10">
          {/* Top bar with Learning Web lrn.svg logo - hidden for enterprise users
              ...
              <div className="flex-1 flex items-center justify-center">
                <div className={cn(
                  ...
                  <div className="space-y-1">
                    <h1 className="font-black text-3xl tracking-tight">{org?.name || 'Learning Web'}</h1>
                    {displayMessage && (
                      <p className={cn(
